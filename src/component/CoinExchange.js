...
//   const convert = () => {
//     // Object.values(data.rates).map((d) => {
//     //   console.log(d.name, d.unit, "sss");
//     // });
//     const unit = Object.values(data.rates).find((unit) => {
...
//         // Convert rates object into an array of key-value pairs
//         const coinData = Object.entries(rates);

//         // Set the 'coin' state with the extracted coin data
//         setCoin(coinData);
//       })
//       .catch((error) => {
...
//             >
//               {Object.values(data.rates).map((d, k) => (
//                 <option key={k} value={d.value} className="text-black-600">
//                   {d.name}
//                 </option>
//               ))}
//             </select>
